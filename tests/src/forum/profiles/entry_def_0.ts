...
export default (orchestrator: Orchestrator<any>) =>  {
  ...
  orchestrator.registerScenario("entry_def_0 CRUD tests", async (s, t) => {
    ...
    const entryContents = {
  "title": "gotta you character",
  "content": "No matter how you travel, it's still you going. It is beets. Just my luck, no ice."
};
    ...
    const update_output = await alice.call(
      ...
      "update_entry_def_0",
      {
        ...
        updatedEntryDef0: {
          "title": "they they going",
  "content": "A computer virus. It is beets. You really think you can fly that thing?"
}
      }
    );
