...
export default (orchestrator: Orchestrator<any>) =>  {
  ...
  orchestrator.registerScenario("entry_def_0 CRUD tests", async (s, t) => {
    ...
    const entryContents = {
  "title": "you go soulful",
  "content": "Forget the fat lady! A computer virus. It's a delight to trust somebody so completely."
};
    ...
    const update_output = await alice.call(
      ...
      "update_entry_def_0",
      {
        ...
        updatedEntryDef0: {
          "title": "dinosaurs think a",
  "content": "Man creates Dinosaurs. Just my luck, no ice. You're obsessed with the fat lady!"
}
      }
    );
