...
pub static ENCLISTS: [u16; 2788] = [
    ...
    // skip 2 unless PredicateView(17)
    0x3036,
    // --> [RexOp1fnaddr8#80b8]
    0x0266, 0x80b8,
    ...
    // skip 2 unless PredicateView(18)
    0x3037,
    // --> [RexOp1gvaddr8#80b8]
    0x0272, 0x80b8,
    // skip 3 unless PredicateView(16)
    0x4035,
    ...
    // skip 3 unless PredicateView(30)
    0x4043,
    // skip 2 unless inst_predicate_32
    0x3020,
    // --> [DynRexMp3icscc_fpr#929]
    0x0258, 0x0929,
    // stop unless PredicateView(32)
    0x1045,
    // stop unless inst_predicate_33
    0x1021,
