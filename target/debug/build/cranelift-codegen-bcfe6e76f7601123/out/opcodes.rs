...
const OPCODE_FORMAT: [InstructionFormat; 271] = [
...
const OPCODE_CONSTRAINTS: [OpcodeConstraints; 271] = [
...
const OPERAND_CONSTRAINTS: [OperandConstraint; 112] = [
